...
import { FulfillmentOption } from "../routers/region.router"
import { RegionService } from "../services/region.service";

/**
 * @oas [get] /admin/v1/regions/{region_id}/fulfillment-options
...
export default async (req, res) => {
  ...
  const fulfillmentProviderService: FulfillmentProviderService =
    req.scope.resolve(FulfillmentProviderService.resolutionKey);
