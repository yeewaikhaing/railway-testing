...
/**
 * @oas [post] /admin/v1/orders/{id}/fulfillments/{fulfillment_id}/cancel
...
export default async (req, res) => {
  ...
  const fulfillmentService: FulfillmentService = req.scope.resolve(FulfillmentService.resolutionKey);
