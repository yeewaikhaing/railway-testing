...
import { defaultAdminVariantFields, defaultAdminVariantRelations } from "../../routers/productVariant.router"
...
export default async (req, res) => {
    const variantService: ProductVariantService = req.scope.resolve(ProductVariantService.resolutionKey);
