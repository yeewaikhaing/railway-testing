...
import { ProductVariantService } from "../../services/productVariant.service";
  ...
  import { defaultStoreVariantRelations } from "../../routers/StorefrontProduct.router"
  import { validator } from "@medusajs/medusa/dist/utils/validator"
  
  /**
   * @oas [get] /store/v1/variants/{variant_id}
  ...
  export default async (req, res) => {
    ...
    const variantService: ProductVariantService = req.scope.resolve(
      ProductVariantService.resolutionKey
    )
    ...
    const rawVariant = await variantService.retrieve(variant_id, {
