...
export class CustomizeAddressMigration1666686978988 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE public."address" ADD COLUMN IF NOT EXISTS "label" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE public."address" ADD COLUMN IF NOT EXISTS "delivery_area_id" character varying`);
