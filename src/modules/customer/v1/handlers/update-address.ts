import { defaultStoreCustomersFields, defaultStoreCustomersRelations } from "../routers/customer.router"

import { StorePostCustomersCustomerAddressesReq } from "./create-address"
...
export default async (req, res) => {
  ...
  await manager.transaction(async (transactionManager) => {
    return await customerService
      ...
      .updateMyAddress(id, address_id, validated)
  })
...
export class StorePostCustomersCustomerAddressesAddressReq extends StorePostCustomersCustomerAddressesReq {}