...
let InviteService = InviteService_1 = class InviteService extends invite_1.default {
    ...
    withTransaction(transactionManager) {
        ...
        const cloned = new InviteService_1(Object.assign(Object.assign({}, this.container), { manager: transactionManager }), this.configModule_);
    ...
    async retrieve(invite_id) {
        return await this.atomicPhase_(async (m) => {
            const inviteRepo = m.getCustomRepository(this.inviteRepository);
            return await inviteRepo.findOne({ where: { id: invite_id } });
        });
    }
};
InviteService.resolutionKey = "inviteService";
InviteService = InviteService_1 = __decorate([
