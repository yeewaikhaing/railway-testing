...
var decorateLineItemsWithTotals = function (cart, req, options) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var totalsService, manager, items;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    totalsService = req.scope.resolve("totalsService");
                    if (!(cart.items && cart.region)) return [3 /*break*/, 2];
                    manager = req.scope.resolve("manager");
                    return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, Promise.all(cart.items.map(function (item) { return __awaiter(void 0, void 0, void 0, function () {
                                            var itemTotals;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, totalsService
                ...
                case 1:
                    items = _a.sent();
                    return [2 /*return*/, Object.assign(cart, { items: items })];
