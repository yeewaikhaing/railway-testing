...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validated, cartService, manager, cart, data;
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    _b.sent();
                                    return [4 /*yield*/, cartService.withTransaction(transactionManager).retrieve(id, {
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, cartService.withTransaction(transactionManager).setPaymentSessions(id)];
                                case 3:
                                    _b.sent();
                                    _b.label = 4;
