...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, provider_id, validated, cartService, manager, cart, data;
            ...
            case 1:
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, cartService.withTransaction(transactionManager).setPaymentSession(id, provider_id)];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, cartService.withTransaction(transactionManager).updatePaymentSession(id, validated.data)];
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
