...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validated, reqContext, lineItemService, cartService, regionService, entityManager, featureFlagRouter, regionId, regions, toCreate, customerService, customer, cart, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                _a.sent();
                return [4 /*yield*/, cartService.retrieve(cart.id, {
