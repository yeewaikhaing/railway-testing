...
var TransactionBaseService = /** @class */ (function () {
    function TransactionBaseService(container, configModule) {
    ...
    TransactionBaseService.prototype.withTransaction = function (transactionManager) {
        ...
        var cloned = new this.constructor(__assign(__assign({}, this.container), { manager: transactionManager }), this.configModule);
