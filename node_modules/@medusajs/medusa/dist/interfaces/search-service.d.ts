...
export declare abstract class AbstractSearchService<T extends TransactionBaseService<never>> extends TransactionBaseService<T> implements ISearchService<T> {
