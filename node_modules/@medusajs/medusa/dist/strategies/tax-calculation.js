...
var TaxCalculationStrategy = /** @class */ (function () {
    ...
    TaxCalculationStrategy.prototype.calculateLineItemsTax = function (items, taxLines, context) {
        ...
        var _loop_1 = function (i) {
            var e_2, _b;
            var allocations = context.allocation_map[i.id] || {};
            var taxableAmount = i.quantity * i.unit_price;
            taxableAmount -=
                ((allocations.discount && allocations.discount.unit_amount) || 0) *
                    i.quantity;
            var lineRates = taxLines.filter(function (tl) { return tl.item_id === i.id; });
            try {
                for (var lineRates_1 = (e_2 = void 0, __values(lineRates)), lineRates_1_1 = lineRates_1.next(); !lineRates_1_1.done; lineRates_1_1 = lineRates_1.next()) {
    ...
    TaxCalculationStrategy.prototype.calculateShippingMethodsTax = function (shipping_methods, taxLines) {
        ...
        var _loop_2 = function (sm) {
            ...
            try {
                for (var lineRates_2 = (e_4 = void 0, __values(lineRates)), lineRates_2_1 = lineRates_2.next(); !lineRates_2_1.done; lineRates_2_1 = lineRates_2.next()) {
                    var lineRate = lineRates_2_1.value;
                ...
                try {
                    if (lineRates_2_1 && !lineRates_2_1.done && (_b = lineRates_2.return)) _b.call(lineRates_2);
                }
