...
var TaxRateService = /** @class */ (function (_super) {
    ...
    TaxRateService.prototype.withTransaction = function (transactionManager) {
        if (!transactionManager) {
            return this;
        }
        var cloned = new TaxRateService({
                        ...
                        return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            function (err) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!(err.code === "23503")) return [3 /*break*/, 2];
                                            ...
                                            return [4 /*yield*/, Promise.all(__spreadArray([
                                                ...
                                                ], __read(ids.map(function (pId) {
                                                    return _this.productService_.retrieve(pId, { select: ["id"] });
                                                })), false))];
                                        case 1:
                                            // A foreign key constraint failed meaning some thing doesn't exist
                                            // either it is a product or the tax rate itself. Using Promise.all
                                    ...
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, Promise.all(__spreadArray([
                                                    ...
                                                    return _this.productTypeService_.retrieve(pId, {
                                                        select: ["id"],
                                                    });
                                                })), false))];
                                        case 1:
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, Promise.all(__spreadArray([
                                                    this.retrieve(id, { select: ["id"] })
                                                ], __read(ids.map(function (sId) {
                                                    return _this.shippingOptionService_.retrieve(sId, { select: ["id"] });
                                                })), false))];
                                        case 1:
                                            // A foreign key constraint failed meaning some thing doesn't exist
                                            // either it is a product or the tax rate itself. Using Promise.all
