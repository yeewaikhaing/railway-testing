 ...
 */
declare class ShippingOptionService extends TransactionBaseService<ShippingOptionService> {
    ...
    constructor({ manager, shippingOptionRepository, shippingOptionRequirementRepository, shippingMethodRepository, fulfillmentProviderService, regionService, }: {
        manager: any;
     ...
     */
    createShippingMethod(optionId: string, data: object, config: CreateShippingMethodDto): Promise<ShippingMethod>;
    /**
     ...
     */
    getPrice_(option: ShippingOption, data: object, cart: Cart | Order | undefined): Promise<number>;
}
