...
var SwapService = /** @class */ (function (_super) {
    ...
    function SwapService(_a) {
        var manager = _a.manager, swapRepository = _a.swapRepository, eventBusService = _a.eventBusService, cartService = _a.cartService, totalsService = _a.totalsService, returnService = _a.returnService, lineItemService = _a.lineItemService, paymentProviderService = _a.paymentProviderService, shippingMethodTaxLineRepository = _a.shippingMethodTaxLineRepository, shippingOptionService = _a.shippingOptionService, fulfillmentService = _a.fulfillmentService, orderService = _a.orderService, inventoryService = _a.inventoryService, customShippingOptionService = _a.customShippingOptionService, lineItemAdjustmentService = _a.lineItemAdjustmentService;
        ...
        _this.shippingTaxLineRepo_ = shippingMethodTaxLineRepository;
    ...
    SwapService.prototype.transformQueryForCart_ = function (config) {
        var select = config.select, relations = config.relations;
        var cartSelects = null;
        var cartRelations = null;
    ...
    SwapService.prototype.retrieve = function (id, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var swapRepo, validatedId, _a, cartSelects, cartRelations, newConfig, query, rels, swap, cart;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        swapRepo = this.manager_.getCustomRepository(this.swapRepository_);
                        validatedId = this.validateId_(id);
                        _a = this.transformQueryForCart_(config), cartSelects = _a.cartSelects, cartRelations = _a.cartRelations, newConfig = __rest(_a, ["cartSelects", "cartRelations"]);
    ...
    SwapService.prototype.createCart = function (swapId, customShippingOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var swap, order, discounts, cart, customShippingOptions_1, customShippingOptions_1_1, customShippingOption, e_2_1, _a, _b, item, e_3_1, shippingTaxLineRepo_1, swapRepo;
                        var e_2, _c, e_3, _d;
                        var _e;
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 17:
                                    ...
                                    return [7 /*endfinally*/];
                                case 18:
                                    if (!(swap.return_order && swap.return_order.shipping_method)) return [3 /*break*/, 20];
                                    shippingTaxLineRepo_1 = this.manager_.getCustomRepository(this.shippingTaxLineRepo_);
                                    return [4 /*yield*/, this.lineItemService_.withTransaction(manager).create({
                                            ...
                                            tax_lines: swap.return_order.shipping_method.tax_lines.map(function (tl) {
                                                return shippingTaxLineRepo_1.create({
                                                    name: tl.name,
                                                    code: tl.code,
                                                    rate: tl.rate,
                                ...
                                case 19:
                                    _f.sent();
                                    _f.label = 20;
                                case 20: return [4 /*yield*/, this.lineItemService_
                                        .withTransaction(manager)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var swap, cart, payment, items, items_1, items_1_1, item, err_3, e_4_1, total, paymentStatus, items_2, items_2_1, item, e_5_1, now, swapRepo, result, _a, _b, method, e_6_1;
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, this.cartService_.retrieve(swap.cart_id, {
                                                select: ["total"],
                                    ...
                                    case 8:
                                        _f.sent();
                                        _f.label = 9;
                                    case 9: return [4 /*yield*/, this.cartService_
                                            .withTransaction(manager)
    ...
    SwapService.prototype.createFulfillment = function (swapId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var swap, order, evaluatedNoNotification, _a, successfullyFulfilled, _b, _c, f, _loop_1, this_1, _d, _e, item, e_8_1, swapRepo, result;
                        var e_9, _f, e_8, _g;
                        var _h;
    ...
    SwapService.prototype.createShipment = function (swapId, fulfillmentId, trackingLinks, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                metadata = config.metadata, no_notification = config.no_notification;
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var swap, evaluatedNoNotification, shipment, _loop_2, this_2, _a, _b, i, e_10_1, swapRepo, result;
                        var e_10, _c;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0: return [4 /*yield*/, this.retrieve(swapId, {
                                        ...
                                        return __generator(this, function (_e) {
                                            switch (_e.label) {
                                                case 0:
                                                    ...
                                                    return [4 /*yield*/, this_2.lineItemService_.withTransaction(manager).update(i.id, {
