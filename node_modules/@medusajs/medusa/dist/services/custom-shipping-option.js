...
var CustomShippingOptionService = /** @class */ (function (_super) {
    ...
    CustomShippingOptionService.prototype.retrieve = function (id, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, customShippingOptionRepo, query, customShippingOption;
    ...
    CustomShippingOptionService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, customShippingOptionRepo, query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        manager = this.manager_;
    ...
    CustomShippingOptionService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var cart_id, shipping_option_id, price, metadata, manager, customShippingOptionRepo, customShippingOption;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cart_id = data.cart_id, shipping_option_id = data.shipping_option_id, price = data.price, metadata = data.metadata;
                        manager = this.manager_;
                        customShippingOptionRepo = manager.getCustomRepository(this.customShippingOptionRepository_);
                        customShippingOption = customShippingOptionRepo.create({
                            cart_id: cart_id,
