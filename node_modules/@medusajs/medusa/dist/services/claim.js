            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var claimRepo, claim, claim_items, shipping_methods, metadata, no_notification, _a, _b, m, e_1_1, shipping_methods_1, shipping_methods_1_1, method, e_2_1, claim_items_1, claim_items_1_1, i, e_3_1;
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 13:
                                        _f.sent();
                                        return [3 /*break*/, 16];
                                    case 14: return [4 /*yield*/, this.shippingOptionService_
                                            .withTransaction(transactionManager)
                                    ...
                                    case 24:
                                        ...
                                        return [4 /*yield*/, this.claimItemService_
                                                .withTransaction(transactionManager)
                                                .update(i.id, i)];
                                    case 25:
                                        _f.sent();
    ...
    ClaimService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var claimRepo, type, claim_items, order, return_shipping, additional_items, shipping_methods, refund_amount, shipping_address, shipping_address_id, no_notification, rest, claim_items_2, claim_items_2_1, item, line, e_4_1, addressId, addressRepo, created_1, saved, toRefund, lines, newItems, additional_items_1, additional_items_1_1, item, e_5_1, newItems_1, newItems_1_1, newItem, e_6_1, evaluatedNoNotification, created, result, calcContext, lineItems, shipping_methods_2, shipping_methods_2_1, method, e_7_1, claim_items_3, claim_items_3_1, ci, e_8_1;
                            ...
                            return __generator(this, function (_j) {
                                switch (_j.label) {
                                    ...
                                    case 12:
                                        newItems = [];
                                        if (!(typeof additional_items !== "undefined")) return [3 /*break*/, 29];
                                        _j.label = 13;
                                    case 13:
                                    ...
                                    case 30:
                                        result = _j.sent();
                                        if (!(result.additional_items && result.additional_items.length)) return [3 /*break*/, 33];
                                        calcContext = this.totalsService_.getCalculationContext(order);
                                        return [4 /*yield*/, this.lineItemService_
                                                .withTransaction(transactionManager)
                                                .list({
                                    ...
                                    case 32:
                                        ...
                                        _j.label = 33;
                                    case 33:
                                        if (!shipping_methods) return [3 /*break*/, 43];
                                        _j.label = 34;
                                    case 34:
                                        _j.trys.push([34, 41, 42, 43]);
                                        shipping_methods_2 = __values(shipping_methods), shipping_methods_2_1 = shipping_methods_2.next();
                                        _j.label = 35;
                                    case 35:
                                        if (!!shipping_methods_2_1.done) return [3 /*break*/, 40];
                                        method = shipping_methods_2_1.value;
                                        if (!method.id) return [3 /*break*/, 37];
                                        return [4 /*yield*/, this.shippingOptionService_
                                                .withTransaction(transactionManager)
                                                .updateShippingMethod(method.id, {
                                    ...
                                    case 36:
                                        _j.sent();
                                        return [3 /*break*/, 39];
                                    case 37: return [4 /*yield*/, this.shippingOptionService_
                                            .withTransaction(transactionManager)
                                            .createShippingMethod(method.option_id, method.data, {
                                            claim_order_id: result.id,
                                            price: method.price,
                                    ...
                                    case 42:
                                        ...
                                        return [7 /*endfinally*/];
                                    case 43:
                                        _j.trys.push([43, 48, 49, 50]);
                                        claim_items_3 = __values(claim_items), claim_items_3_1 = claim_items_3.next();
                                        _j.label = 44;
                                    case 44:
                                        if (!!claim_items_3_1.done) return [3 /*break*/, 47];
                                        ci = claim_items_3_1.value;
                                        return [4 /*yield*/, this.claimItemService_
                                                .withTransaction(transactionManager)
                                                .create(__assign(__assign({}, ci), { claim_order_id: result.id }))];
                                    case 45:
                                        _j.sent();
                                        _j.label = 46;
                                    case 46:
                                    ...
                                    case 49:
                                        ...
                                        return [7 /*endfinally*/];
                                    case 50:
                                        if (!return_shipping) return [3 /*break*/, 52];
                                        return [4 /*yield*/, this.returnService_.withTransaction(transactionManager).create({
                                                order_id: order.id,
                                                claim_order_id: result.id,
                                                items: claim_items.map(function (ci) { return ({
                                                    item_id: ci.item_id,
                                    ...
                                    case 51:
                                        _j.sent();
                                        _j.label = 52;
                                    case 52: return [4 /*yield*/, this.eventBus_
                                            .withTransaction(transactionManager)
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                                var claim, order, evaluatedNoNotification, fulfillments, successfullyFulfilledItems, fulfillments_1, fulfillments_1_1, fulfillment, _loop_1, this_1, _a, _b, item, e_11_1, claimRepo, claimOrder, fulfillments_2, fulfillments_2_1, fulfillment, e_12_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        metadata = config.metadata, no_notification = config.no_notification;
                        return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                                var claim, evaluatedNoNotification, shipment, _loop_2, this_2, _a, _b, additionalItem, e_14_1, claimRepo, claimOrder;
                                var e_14, _c;
                                                ...
                                                return __generator(this, function (_e) {
                                                    switch (_e.label) {
                                                        case 0:
                                                            ...
                                                            return [4 /*yield*/, this_2.lineItemService_
                                                                    .withTransaction(transactionManager)
