...
var products_1 = require("../api/routes/admin/products");
/**
...
var ProductService = /** @class */ (function (_super) {
    ...
    ProductService.prototype.list = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var productRepo, priceIndex, _d, q, query, relations, qb, raw, products, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        productRepo = this.manager_.getCustomRepository(this.productRepository_);
                        priceIndex = (_b = (_a = config.relations) === null || _a === void 0 ? void 0 : _a.indexOf("variants.prices")) !== null && _b !== void 0 ? _b : -1;
                        ...
                        _d = this.prepareListQuery_(selector, config), q = _d.q, query = _d.query, relations = _d.relations;
                        if (!q) return [3 /*break*/, 2];
                        qb = this.getFreeTextQueryBuilder_(productRepo, query, q);
                        return [4 /*yield*/, qb.getMany()];
                    case 1:
                        raw = _f.sent();
                        return [2 /*return*/, productRepo.findWithRelations(relations, raw.map(function (i) { return i.id; }), (_c = query.withDeleted) !== null && _c !== void 0 ? _c : false)];
                    case 2:
                        products = productRepo.findWithRelations(relations, query);
                        if (!(priceIndex > -1)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.setAdditionalPrices(products, config.currency_code, config.region_id, config.cart_id, config.customer_id, config.include_discount_prices)];
                    case 3:
                        _e = _f.sent();
                        return [3 /*break*/, 5];
                    case 4:
    ...
    ProductService.prototype.listAndCount = function (selector, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var productRepo, priceIndex, _d, q, query, relations, qb, _e, raw, count_1, products_2, _f, products, count, productsWithAdditionalPrices;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        _e = __read.apply(void 0, [_g.sent(), 2]), raw = _e[0], count_1 = _e[1];
                        return [4 /*yield*/, productRepo.findWithRelations(relations, raw.map(function (i) { return i.id; }), (_c = query.withDeleted) !== null && _c !== void 0 ? _c : false)];
                    case 2:
                        products_2 = _g.sent();
                        return [2 /*return*/, [products_2, count_1]];
                    case 3: return [4 /*yield*/, productRepo.findWithRelationsAndCount(relations, query)];
                    case 4:
                        _f = __read.apply(void 0, [_g.sent(), 2]), products = _f[0], count = _f[1];
                        if (!(priceIndex > -1)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.setAdditionalPrices(products, config.currency_code, config.region_id, config.cart_id, config.customer_id, config.include_discount_prices)];
                    case 5:
                        productsWithAdditionalPrices = _g.sent();
                        return [2 /*return*/, [productsWithAdditionalPrices, count]];
    ...
    ProductService.prototype.retrieve = function (productId, config) {
        var _a, _b;
        if (config === void 0) { config = { include_discount_prices: false }; }
        return __awaiter(this, void 0, void 0, function () {
            var productRepo, validatedId, priceIndex, query, rels, product, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (!(priceIndex > -1)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.setAdditionalPrices(product, config.currency_code, config.region_id, config.cart_id, config.customer_id, config.include_discount_prices)];
                    case 2:
                        _c = _d.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    ProductService.prototype.retrieveByHandle = function (productHandle, config) {
        ...
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var productRepo, priceIndex, query, rels, product, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        productRepo = this.manager_.getCustomRepository(this.productRepository_);
    ...
    ProductService.prototype.retrieveVariants = function (productId, config) {
        if (config === void 0) { config = {
            skip: 0,
            take: 50,
            relations: products_1.defaultAdminProductsVariantsRelations,
        }; }
        return __awaiter(this, void 0, void 0, function () {
            var product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.retrieve(productId, config)];
                    case 1:
                        product = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        created = productTypeRepository.create({
                            value: type.value,
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var productRepo, optionRepo, options, tags, type, images, rest, product_1, _a, _b, _c, _d, result, error_1;
                        var _this = this;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 6:
                                    _c.type_id = _e.sent();
                                    _e.label = 7;
                                case 7: return [4 /*yield*/, productRepo.save(product_1)];
                                case 8:
                                    product_1 = _e.sent();
                                    _d = product_1;
                                    return [4 /*yield*/, Promise.all(options.map(function (o) { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        res = optionRepo.create(__assign(__assign({}, o), { product_id: product_1.id }));
     ...
     */
    ProductService.prototype.decorate = function (productId, fields, expandFields, config) {
        var _a;
        if (fields === void 0) { fields = []; }
        if (expandFields === void 0) { expandFields = []; }
        if (config === void 0) { config = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var requiredFields, priceIndex, product, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        requiredFields = ["id", "metadata"];
                        priceIndex = (_a = expandFields.indexOf("variants.prices")) !== null && _a !== void 0 ? _a : -1;
                        if (priceIndex >= 0 && expandFields.length) {
                            expandFields = __spreadArray([], __read(expandFields), false);
     ...
     */
    ProductService.prototype.setAdditionalPrices = function (products, currency_code, region_id, cart_id, customer_id, include_discount_prices) {
        if (include_discount_prices === void 0) { include_discount_prices = false; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var cartRepo, regionId, currencyCode, cart, productArray, priceSelectionStrategy, productsWithPrices;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 1:
                                    ...
                                    _a.label = 2;
                                case 2:
                                    productArray = Array.isArray(products) ? products : [products];
                                    priceSelectionStrategy = this.priceSelectionStrategy_.withTransaction(manager);
                                    return [4 /*yield*/, Promise.all(productArray.map(function (p) { return __awaiter(_this, void 0, void 0, function () {
                                            var _a;
                                            var _this = this;
                                            var _b;
                                            return __generator(this, function (_c) {
                                                switch (_c.label) {
                                                    case 0:
                                                        ...
                                                        return [4 /*yield*/, Promise.all(p.variants.map(function (v) { return __awaiter(_this, void 0, void 0, function () {
                                                                ...
                                                                return __generator(this, function (_a) {
                                                                    switch (_a.label) {
                                                                        case 0: return [4 /*yield*/, priceSelectionStrategy.calculateVariantPrice(v.id, {
                                                                                region_id: regionId,
                                                                        ...
                                                                        case 1:
                                                                            prices = _a.sent();
                                                                            return [2 /*return*/, __assign(__assign({}, v), { prices: prices.prices, original_price: prices.originalPrice, calculated_price: prices.calculatedPrice, calculated_price_type: prices.calculatedPriceType })];
                                                                    }
                                                                });
                                                            }); }))];
                                                    case 1:
                                ...
                                case 3:
                                    productsWithPrices = _a.sent();
                                    return [2 /*return*/, Array.isArray(products)
                                            ? productsWithPrices
