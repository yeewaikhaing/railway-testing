 ...
 */
declare class TotalsService extends TransactionBaseService<TotalsService> {
    protected manager_: EntityManager;
    protected transactionManager_: EntityManager;
    private taxProviderService_;
    private taxCalculationStrategy_;
     ...
     */
    getAllocationMap(orderOrCart: Cart | Order, options?: AllocationMapOptions): LineAllocationsMap;
    /**
     ...
     */
    getCalculationContext(cartOrOrder: Cart | Order, options?: CalculationContextOptions): TaxCalculationContext;
    /**
