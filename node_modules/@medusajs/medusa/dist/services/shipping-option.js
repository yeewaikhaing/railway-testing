...
var ShippingOptionService = /** @class */ (function (_super) {
    ...
    function ShippingOptionService(_a) {
        var manager = _a.manager, shippingOptionRepository = _a.shippingOptionRepository, shippingOptionRequirementRepository = _a.shippingOptionRequirementRepository, shippingMethodRepository = _a.shippingMethodRepository, fulfillmentProviderService = _a.fulfillmentProviderService, regionService = _a.regionService;
        var _this = 
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        option = _a.sent();
                                        methodRepo = manager.getCustomRepository(this.methodRepository_);
                                        if (!(typeof config.cart !== "undefined")) return [3 /*break*/, 3];
                        ...
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 4:
                                    ...
                                    if (!(typeof data.requirements !== "undefined")) return [3 /*break*/, 12];
                                    acc = [];
                                    _loop_1 = function (r) {
                                        var validated;
                ...
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 1:
                                    option = _f.sent();
                                    if (!(typeof update.metadata !== "undefined")) return [3 /*break*/, 3];
                                    _a = option;
                                ...
                                case 3:
                                    ...
                                    if (!(typeof update.requirements !== "undefined")) return [3 /*break*/, 14];
                                    acc = [];
                                    _loop_2 = function (r) {
                                        var validated;
                                        return __generator(this, function (_g) {
                                ...
                                case 13:
                                    ...
                                    _f.label = 14;
                                case 14:
                                    if (!(typeof update.price_type !== "undefined")) return [3 /*break*/, 16];
                                    _d = option;
