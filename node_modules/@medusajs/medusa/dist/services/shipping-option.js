...
var ShippingOptionService = /** @class */ (function (_super) {
                        ...
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 4:
                                    ...
                                    if (!(0, utils_1.isDefined)(data.requirements)) return [3 /*break*/, 12];
                                    acc = [];
                                    _loop_1 = function (r) {
                                        var validated;
    ...
    ShippingOptionService.prototype.update = function (optionId, update) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var option, _a, acc, _loop_2, this_2, _b, _c, r, e_3_1, accReqs_1, toRemove, _d, optionRepo;
                        var e_3, _e;
                        var _this = this;
                        return __generator(this, function (_f) {
                            switch (_f.label) {
                                ...
                                case 1:
                                    option = _f.sent();
                                    if (!(0, utils_1.isDefined)(update.metadata)) return [3 /*break*/, 3];
                                    _a = option;
                                    return [4 /*yield*/, (0, utils_1.setMetadata)(option, update.metadata)];
                                case 2:
                                    _a.metadata = _f.sent();
                                    _f.label = 3;
                                case 3:
                                    ...
                                    if (!(0, utils_1.isDefined)(update.requirements)) return [3 /*break*/, 14];
                                    acc = [];
                                    _loop_2 = function (r) {
                                        var validated;
                                        return __generator(this, function (_g) {
                                ...
                                case 13:
                                    ...
                                    _f.label = 14;
                                case 14:
                                    if (!(0, utils_1.isDefined)(update.price_type)) return [3 /*break*/, 16];
                                    _d = option;
