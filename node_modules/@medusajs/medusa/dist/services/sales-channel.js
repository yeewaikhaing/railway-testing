...
var SalesChannelService = /** @class */ (function (_super) {
    ...
    SalesChannelService.prototype.retrieve = function (salesChannelId, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var manager, salesChannelRepo, query, salesChannel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, salesChannelRepo.findOne(query)];
                    case 1:
                        salesChannel = _a.sent();
                        if (!salesChannel) {
                            throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.NOT_FOUND, "Sales channel with id ".concat(salesChannelId, " was not found"));
                        }
