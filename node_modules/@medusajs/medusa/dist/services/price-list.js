...
var PriceListService = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var priceListRepo, moneyAmountRepo, prices, customer_groups, rest, entity, priceList, result, error_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        prices = priceListObject.prices, customer_groups = priceListObject.customer_groups, rest = __rest(priceListObject, ["prices", "customer_groups"]);
                                        _a.label = 1;
                                    case 1:
                                        _a.trys.push([1, 8, , 9]);
                                        entity = priceListRepo.create(rest);
    ...
    PriceListService.prototype.update = function (id, update) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var priceListRepo, moneyAmountRepo, priceList, prices, customer_groups, rest, prices_, _a, _b, _c, key, value;
                            var e_1, _d;
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        priceList = _e.sent();
                                        prices = update.prices, customer_groups = update.customer_groups, rest = __rest(update, ["prices", "customer_groups"]);
                                        if (!prices) return [3 /*break*/, 4];
    ...
    PriceListService.prototype.addCurrencyFromRegion = function (prices) {
        return __awaiter(this, void 0, void 0, function () {
            var prices_, prices_1, prices_1_1, p, region, e_3_1;
            var e_3, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
