    ...
    DraftOrderService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var draftOrderRepo, shipping_methods, no_notification_order, items, rawCart, discounts, discounts_1, discounts_1_1, code, e_1_1, createdCart, draftOrder, result, items_1, items_1_1, item, line, price, e_2_1, shipping_methods_1, shipping_methods_1_1, method, e_3_1;
                            ...
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 8: return [4 /*yield*/, this.cartService_
                                            .withTransaction(transactionManager)
                                            .create(__assign({ type: models_1.CartType.DRAFT_ORDER }, rawCart))];
                                    case 9:
                                        createdCart = _d.sent();
                                    ...
                                    case 14:
                                        ...
                                        return [4 /*yield*/, this.lineItemService_
                                                .withTransaction(transactionManager)
                                                .create(__assign(__assign({}, line), { cart_id: createdCart.id }))];
                                    case 15:
                                        _d.sent();
                                        return [3 /*break*/, 18];
                                    case 16:
