...
var TotalsService = /** @class */ (function (_super) {
    ...
    TotalsService.prototype.getShippingMethodTotals = function (shippingMethod, cartOrOrder, opts) {
        ...
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var calculationContext, totals, orderLines, includesTax, _b, hasFreeShipping;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getCalculationContext(cartOrOrder, {
                    ...
                    case 1:
                        ...
                        if (!opts.include_tax) return [3 /*break*/, 6];
                        if (!((0, orders_1.isOrder)(cartOrOrder) && cartOrOrder.tax_rate != null)) return [3 /*break*/, 2];
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        if (!(totals.tax_lines.length === 0)) return [3 /*break*/, 4];
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4:
                        if (!(totals.tax_lines.length > 0)) return [3 /*break*/, 6];
    ...
    TotalsService.prototype.getAllocationMap = function (orderOrCart, options) {
        ...
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var allocationMap, lineDiscounts, discount, lineDiscounts_1, lineDiscounts_1_1, ld, lineGiftCards, subtotal, giftCardTotal, nominator, percentage_1, lineGiftCards_1, lineGiftCards_1_1, lgc;
            var e_4, _b, e_5, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!!options.exclude_gift_cards) return [3 /*break*/, 4];
                        lineGiftCards = [];
                        if (!(orderOrCart.gift_cards && orderOrCart.gift_cards.length)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.getSubtotal(orderOrCart)];
                    case 1:
                        subtotal = _d.sent();
                        return [4 /*yield*/, this.getGiftCardTotal(orderOrCart)
                            // If the fixed discount exceeds the subtotal we should
                            // calculate a 100% discount
                        ];
                    case 2:
                        giftCardTotal = _d.sent();
                        nominator = Math.min(giftCardTotal.total, subtotal);
                        percentage_1 = nominator / subtotal;
                        lineGiftCards = orderOrCart.items.map(function (l) {
                            return {
                                item: l,
                                amount: Math.round(l.unit_price * l.quantity * percentage_1),
                            };
                        });
                        _d.label = 3;
                    case 3:
                        try {
                            for (lineGiftCards_1 = __values(lineGiftCards), lineGiftCards_1_1 = lineGiftCards_1.next(); !lineGiftCards_1_1.done; lineGiftCards_1_1 = lineGiftCards_1.next()) {
                                lgc = lineGiftCards_1_1.value;
                            ...
                            try {
                                if (lineGiftCards_1_1 && !lineGiftCards_1_1.done && (_c = lineGiftCards_1.return)) _c.call(lineGiftCards_1);
                            }
                            finally { if (e_5) throw e_5.error; }
                        }
                        _d.label = 4;
                    case 4: return [2 /*return*/, allocationMap];
                }
            });
        });
    };
    ...
    TotalsService.prototype.getRefundTotal = function (order, lineItems) {
        return __awaiter(this, void 0, void 0, function () {
            var itemIds, _a, _b, s, swapItemIds, _c, _d, c, claimItemIds, refunds, lineItems_1, lineItems_1_1, item, refund, e_6_1;
            var e_7, _e, e_8, _f, e_6, _g;
    ...
    TotalsService.prototype.getLineItemTotals = function (lineItem, cartOrOrder, options) {
        ...
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var calculationContext, lineItemAllocation, subtotal, gift_card_total, discount_total, lineItemTotals, taxRate, includesTax, taxIncludedInPrice, taxLines, orderLines, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        if (!options.include_tax) return [3 /*break*/, 7];
                        if (!((0, orders_1.isOrder)(cartOrOrder) && cartOrOrder.tax_rate != null)) return [3 /*break*/, 2];
                    ...
                    case 2:
                        taxLines = void 0;
                        if (!(options.use_tax_lines || (0, orders_1.isOrder)(cartOrOrder))) return [3 /*break*/, 3];
                        if (typeof lineItem.tax_lines === "undefined") {
                        ...
                        return [3 /*break*/, 6];
                    case 3:
                        if (!lineItem.is_return) return [3 /*break*/, 4];
                        if (typeof lineItem.tax_lines === "undefined") {
                            throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.UNEXPECTED_STATE, "Return Line Items must join tax lines");
                        }
                        taxLines = lineItem.tax_lines;
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.taxProviderService_
                            .withTransaction(this.manager_)
                            .getTaxLines(cartOrOrder.items, calculationContext)];
                    case 5:
                        orderLines = _e.sent();
                    ...
                    case 6:
                        ...
                        _e.label = 7;
                    case 7:
                        if (!(lineItemTotals.tax_lines.length > 0)) return [3 /*break*/, 10];
                        _c = lineItemTotals;
                    ...
                    case 9:
                        ...
                        lineItemTotals.original_total += lineItemTotals.original_tax_total;
                        _e.label = 10;
                    case 10: return [2 /*return*/, lineItemTotals];
                }
            });
        });
    };
    ...
    TotalsService.prototype.getGiftCardTotal = function (cartOrOrder) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var subtotal, discountTotal, giftCardable, toReturn, orderGiftCardAmount;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getSubtotal(cartOrOrder)];
                    case 1:
