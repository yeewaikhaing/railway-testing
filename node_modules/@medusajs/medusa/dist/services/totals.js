...
var TotalsService = /** @class */ (function (_super) {
    ...
    function TotalsService(_a) {
        var manager = _a.manager, taxProviderService = _a.taxProviderService, taxCalculationStrategy = _a.taxCalculationStrategy;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        giftCardTotal = options.exclude_gift_cards
                            ? { total: 0 }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.taxProviderService_
    ...
    TotalsService.prototype.getAllocationMap = function (orderOrCart, options) {
        ...
        if (!options.exclude_gift_cards) {
            ...
            if (orderOrCart.gift_cards && orderOrCart.gift_cards.length) {
                ...
                var nominator = Math.min(giftCardTotal.total, subtotal);
    ...
    TotalsService.prototype.getLineItemDiscountAdjustment = function (lineItem, discount) {
        var matchingDiscount = lineItem.adjustments.find(function (adjustment) { return adjustment.discount_id === discount.id; });
        if (!matchingDiscount) {
            return 0;
        }
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        taxLines = lineItem.tax_lines;
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.taxProviderService_
                            .withTransaction(this.manager_)
                            .getTaxLines(cartOrOrder.items, calculationContext)];
                    case 4:
                        orderLines = _e.sent();
                ...
                switch (_b.label) {
                    case 0:
                        if ((_a = cartOrOrder.region) === null || _a === void 0 ? void 0 : _a.gift_cards_taxable) {
                            return [2 /*return*/, this.getSubtotal(cartOrOrder) - this.getDiscountTotal(cartOrOrder)];
                        }
                        return [4 /*yield*/, this.getTotal(cartOrOrder, {
    ...
    TotalsService.prototype.getGiftCardTotal = function (cartOrOrder) {
        ...
        if ("gift_card_transactions" in cartOrOrder) {
            ...
            return cartOrOrder.gift_card_transactions.reduce(function (acc, next) {
                var _a;
        ...
        var orderGiftCardAmount = Math.min(giftCardable, toReturn);
        if ((_a = cartOrOrder.region) === null || _a === void 0 ? void 0 : _a.gift_cards_taxable) {
            return {
    ...
    TotalsService.prototype.getDiscountTotal = function (cartOrOrder) {
        ...
        var discountTotal = this.getLineItemAdjustmentsTotal(cartOrOrder);
        if (subtotal < 0) {
