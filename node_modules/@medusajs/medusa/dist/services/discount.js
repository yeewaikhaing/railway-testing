            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function () { return __awaiter(_this, void 0, void 0, function () {
                            var adjustment, discount, _a, type, value, allocation, fullItemPrice, subtotal, nominator, itemRelativeToSubtotal, totalItemPercentage;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        adjustment = 0;
                                    ...
                                    case 1:
                                        ...
                                        if (type === discount_rule_1.DiscountRuleType.PERCENTAGE) {
                                            adjustment = Math.round((fullItemPrice / 100) * value);
                                        }
                                        else if (type === discount_rule_1.DiscountRuleType.FIXED &&
                                            allocation === discount_rule_1.AllocationType.TOTAL) {
                                            subtotal = this.totalsService_.getSubtotal(cart, {
                                                excludeNonDiscounts: true,
                                            });
                                            nominator = Math.min(value, subtotal);
                                            itemRelativeToSubtotal = lineItem.unit_price / subtotal;
                                            totalItemPercentage = itemRelativeToSubtotal * lineItem.quantity;
