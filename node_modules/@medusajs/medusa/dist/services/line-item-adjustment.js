...
var LineItemAdjustmentService = /** @class */ (function (_super) {
    ...
    LineItemAdjustmentService.prototype.withTransaction = function (transactionManager) {
        if (!transactionManager) {
            return this;
        }
        var cloned = new LineItemAdjustmentService({
     ...
     */
    LineItemAdjustmentService.prototype.delete = function (selectorOrId) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.atomicPhase_(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        var lineItemAdjustmentRepo, query, lineItemAdjustments;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    lineItemAdjustmentRepo = manager.getCustomRepository(this.lineItemAdjustmentRepo_);
                                    if (!(typeof selectorOrId === "string")) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.delete({ id: selectorOrId })];
                                case 1: return [2 /*return*/, _a.sent()];
                                case 2:
                                    query = this.buildQuery_(selectorOrId);
                                    return [4 /*yield*/, lineItemAdjustmentRepo.find(query)];
                                case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(cart.items.map(function (li) { return _this.createAdjustmentForLineItem(cart, li); }))];
