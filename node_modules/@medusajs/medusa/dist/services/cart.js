...
var CartService = /** @class */ (function (_super) {
    ...
    CartService.prototype.decorateTotals_ = function (cart, totalsToSelect, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var totals, totalsToSelect_1, totalsToSelect_1_1, key, _a, _b, _c, giftCardBreakdown, e_1_1;
            var e_1, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 9:
                        {
                            giftCardBreakdown = this.totalsService_.getGiftCardTotal(cart);
                                    ...
                                    case 8:
                                        ...
                                        try {
                                            for (remainingFields_1 = __values(remainingFields), remainingFields_1_1 = remainingFields_1.next(); !remainingFields_1_1.done; remainingFields_1_1 = remainingFields_1.next()) {
                                                ...
                                                if (typeof data[remainingField] !== "undefined" &&
    ...
    CartService.prototype.getValidatedSalesChannel = function (salesChannelId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof salesChannelId !== "undefined")) return [3 /*break*/, 2];
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 2:
                                        ...
                                        return [3 /*break*/, 5];
                                    case 3:
                                        if (!(typeof data.email !== "undefined")) return [3 /*break*/, 5];
                                        return [4 /*yield*/, this.createOrFetchUserFromEmail_(data.email)];
                                    case 4:
                                        customer = _e.sent();
                                    ...
                                    case 5:
                                        if (!(typeof data.customer_id !== "undefined" ||
                                            typeof data.region_id !== "undefined")) return [3 /*break*/, 7];
                                        return [4 /*yield*/, this.updateUnitPrices_(cart, data.region_id, data.customer_id)];
                                    case 6:
                                        _e.sent();
                                        _e.label = 7;
                                    case 7:
                                        if (!(typeof data.region_id !== "undefined")) return [3 /*break*/, 9];
                                    ...
                                    case 20:
                                        ...
                                        return [4 /*yield*/, Promise.all(((_d = data.gift_cards) !== null && _d !== void 0 ? _d : []).map(function (_a) {
                                                var code = _a.code;
                                                return _this.applyGiftCard_(cart, code);
                                            }))];
                                    case 21:
                                        _e.sent();
                                        _e.label = 22;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(itemsToRemove.map(function (item) {
                                return _this.removeLineItem(cart.id, item.id);
                            }))];
                    case 3:
                        results = _c.sent();
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        newDiscounts = toParse.map(function (discountToParse) {
                                            ...
                                            switch ((_a = discountToParse.rule) === null || _a === void 0 ? void 0 : _a.type) {
                                                ...
                                                default:
                                                    if (!sawNotShipping) {
                                                        sawNotShipping = true;
                                                        if ((rule === null || rule === void 0 ? void 0 : rule.type) !== "free_shipping") {
                                                            return discount;
                                                        }
                                                        return discountToParse;
                                                    }
                                        ...
                                        if (!((rule === null || rule === void 0 ? void 0 : rule.type) !== "free_shipping" && (cart === null || cart === void 0 ? void 0 : cart.items))) return [3 /*break*/, 4];
    ...
    CartService.prototype.addShippingMethod = function (cartId, optionId, data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var cart, cartCustomShippingOptions, customShippingOption, shipping_methods, shippingMethodConfig, newShippingMethod, methods, shipping_methods_1, shipping_methods_1_1, shippingMethod, e_3_1, updatedCart;
                            var e_3, _a;
                            var _this = this;
                            var _b;
                            return __generator(this, function (_c) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _c.label = 3;
                    case 3:
                        if (!(countryCode !== null)) return [3 /*break*/, 5];
                    ...
                    case 9:
                        ...
                        if (!((_b = cart === null || cart === void 0 ? void 0 : cart.items) === null || _b === void 0 ? void 0 : _b.length)) return [3 /*break*/, 11];
                    ...
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        cart = _a.sent();
                                        calculationContext = this.totalsService_
                                            .withTransaction(transactionManager)
    ...
    CartService.prototype.deleteMetadata = function (cartId, key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var cartRepo, validatedId, cart, updated, updatedCart;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        cartRepo = transactionManager.getCustomRepository(this.cartRepository_);
