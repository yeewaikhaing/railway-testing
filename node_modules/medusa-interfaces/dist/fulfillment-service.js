...
var BaseFulfillmentService = /** @class */ (function (_super) {
     ...
     */
    BaseFulfillmentService.prototype.validateFulfillmentData = function (data, cart) {
     ...
     */
    BaseFulfillmentService.prototype.calculatePrice = function (data, cart) {
        throw Error("calculatePrice must be overridden by the child class");
    };
    BaseFulfillmentService.prototype.createFulfillment = function () {
